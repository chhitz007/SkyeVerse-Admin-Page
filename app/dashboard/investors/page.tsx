...
export default function InvestorsPage() {
    ...
    const handleBulkDelete = async () => {
        ...
        const confirmDelete = confirm(
            `Delete ${selectedIds.length} submission(s)?`
        )
        if (!confirmDelete) return

        await Promise.all(
            selectedIds.map((id) =>
                deleteDoc(doc(db, "investorInquiries", id))
            )
        )
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                    ...
                    <div className="flex gap-3 flex-wrap">
                        <button
                            ...
                            className="bg-white/10 hover:bg-white/20 text-white px-4 py-2 rounded-lg transition cursor-pointer"
                        >
                            ← Back
                        </button>
                        ...
                        {!deleteMode ? (
                            ...
                            <>
                                <button
                                    ...
                                    className="bg-red-700 hover:bg-red-800 text-white px-4 py-2 rounded-lg cursor-pointer transition"
                                >
                ...
                <div className="flex flex-col lg:flex-row gap-4 mb-6">
                    ...
                    <select
                        ...
                        className="bg-slate-900 border border-white/20 text-white rounded-xl px-4 py-2 focus:outline-none"
                    >
                    ...
                    <div className="max-h-[70vh] overflow-y-auto">
                        ...
                        {filteredData.map((item) => (
                            ...
                            <div
                                key={item.id}
                                onClick={() => {
                                    if (!deleteMode) setSelected(item)
                                }}
            ...
            {selected && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
                    ...
                    <div className="bg-slate-900 border border-white/10 rounded-2xl w-full max-w-2xl p-6 relative max-h-[85vh] overflow-y-auto">
                        ...
                        <Detail label="Represents Firm" value={selected.representsFirm ? "Yes" : "No"} />
